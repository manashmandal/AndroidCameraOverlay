...
public class MainActivity extends Activity {
    ...
    public void onUseCameraClick(View button) {
        ...
        intent.putExtra(MainActivity.WHICH_CAMERA, MainActivity.BACK_CAMERA);
        startActivityForResult(intent, REQ_CAMERA_IMAGE);
    }

    @FromXML
    public void onUseFrontCameraClick(View button){
        Intent intent = new Intent(this, CameraActivity.class);
        intent.putExtra(MainActivity.WHICH_CAMERA, MainActivity.FRONT_CAMERA);
        startActivityForResult(intent, REQ_CAMERA_IMAGE);
    }
